...
module.exports = {
  en: [
    ...
    ['How long does delivery take?',
     'Usually 30 to 45 minutes from the moment you send your order. Weather, traffic and load shedding are real here, so if your order is running late we message you rather than leave you guessing.'],
    ['How do I pay?',
     "Cash on delivery, or eSewa, Khalti and Fonepay if you'd rather settle it digitally. For digital payment we send a request once you confirm the order. There's no minimum order value."],
    ['How do I place an order?',
     "Pick your blends, add them to the cart, and checkout writes the whole order into a WhatsApp message. Press send and we've got it. No account, no app, no sign up, and nothing to install."],
    ['Are the ingredients fresh, and do you list allergens?',
     "Every cup is blended after you order it, so nothing sits in a fridge losing its goodness. Every product page lists its allergens. We blend in a shared kitchen, so we can't promise zero cross contact with dairy, peanuts, tree nuts or gluten. If a reaction would be serious, message us before ordering."],
  ],
  ne: [
