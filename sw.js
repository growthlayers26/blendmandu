...
const VERSION = "4385b374";
const CACHE = 'blendmandu-' + VERSION;
const PRECACHE = [
  "/assets/css/style.css?v=4385b374",
  "/assets/js/app.js?v=4385b374",
  "/assets/js/products.js?v=4385b374",
  "/assets/js/i18n.js?v=4385b374",
  "/assets/js/analytics.js?v=4385b374",
