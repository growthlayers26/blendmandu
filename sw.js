...
const VERSION = "0e3e5a04";
const CACHE = 'blendmandu-' + VERSION;
const PRECACHE = [
  "/assets/css/style.css?v=0e3e5a04",
  "/assets/js/app.js?v=0e3e5a04",
  "/assets/js/products.js?v=0e3e5a04",
  "/assets/js/i18n.js?v=0e3e5a04",
  "/assets/js/analytics.js?v=0e3e5a04",
