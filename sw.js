...
const VERSION = "8860a488";
const CACHE = 'blendmandu-' + VERSION;
const PRECACHE = [
  "/assets/css/style.css?v=8860a488",
  "/assets/js/app.js?v=8860a488",
  "/assets/js/products.js?v=8860a488",
  "/assets/js/i18n.js?v=8860a488",
  "/assets/js/analytics.js?v=8860a488",
