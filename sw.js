...
const VERSION = "8e65a47f";
const CACHE = 'blendmandu-' + VERSION;
const PRECACHE = [
  "/assets/css/style.css?v=8e65a47f",
  "/assets/js/app.js?v=8e65a47f",
  "/assets/js/products.js?v=8e65a47f",
  "/assets/js/i18n.js?v=8e65a47f",
  "/assets/js/analytics.js?v=8e65a47f",
