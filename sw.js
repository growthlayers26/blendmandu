...
const VERSION = "3cb6d39b";
const CACHE = 'blendmandu-' + VERSION;
const PRECACHE = [
  "/assets/css/style.css?v=3cb6d39b",
  "/assets/js/app.js?v=3cb6d39b",
  "/assets/js/products.js?v=3cb6d39b",
  "/assets/js/i18n.js?v=3cb6d39b",
  "/assets/js/analytics.js?v=3cb6d39b",
