...
const VERSION = "12cfd059";
const CACHE = 'blendmandu-' + VERSION;
const PRECACHE = [
  "/assets/css/style.css?v=12cfd059",
  "/assets/js/app.js?v=12cfd059",
  "/assets/js/products.js?v=12cfd059",
  "/assets/js/i18n.js?v=12cfd059",
  "/assets/js/analytics.js?v=12cfd059",
