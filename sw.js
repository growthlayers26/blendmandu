...
const VERSION = "3282688f";
const CACHE = 'blendmandu-' + VERSION;
const PRECACHE = [
  "/assets/css/style.css?v=3282688f",
  "/assets/js/app.js?v=3282688f",
  "/assets/js/products.js?v=3282688f",
  "/assets/js/i18n.js?v=3282688f",
  "/assets/js/analytics.js?v=3282688f",
