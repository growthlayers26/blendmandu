...
const VERSION = "da3766cb";
const CACHE = 'blendmandu-' + VERSION;
const PRECACHE = [
  "/assets/css/style.css?v=da3766cb",
  "/assets/js/app.js?v=da3766cb",
  "/assets/js/products.js?v=da3766cb",
  "/assets/js/i18n.js?v=da3766cb",
  "/assets/js/analytics.js?v=da3766cb",
