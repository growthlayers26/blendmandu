...
const VERSION = "64df67b1";
const CACHE = 'blendmandu-' + VERSION;
const PRECACHE = [
  "/assets/css/style.css?v=64df67b1",
  "/assets/js/app.js?v=64df67b1",
  "/assets/js/products.js?v=64df67b1",
  "/assets/js/i18n.js?v=64df67b1",
  "/assets/js/analytics.js?v=64df67b1",
