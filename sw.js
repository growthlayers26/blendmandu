...
const VERSION = "dbc055ca";
const CACHE = 'blendmandu-' + VERSION;
const PRECACHE = [
  "/assets/css/style.css?v=dbc055ca",
  "/assets/js/app.js?v=dbc055ca",
  "/assets/js/products.js?v=dbc055ca",
  "/assets/js/i18n.js?v=dbc055ca",
  "/assets/js/analytics.js?v=dbc055ca",
