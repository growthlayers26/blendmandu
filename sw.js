...
const VERSION = "1f5d71df";
const CACHE = 'blendmandu-' + VERSION;
const PRECACHE = [
  "/assets/css/style.css?v=1f5d71df",
  "/assets/js/app.js?v=1f5d71df",
  "/assets/js/products.js?v=1f5d71df",
  "/assets/js/i18n.js?v=1f5d71df",
  "/assets/js/analytics.js?v=1f5d71df",
